...
const navigation = [
  { name: 'Home',       href: '#center',   current: true },
  { name: 'Explore',   href: '#post-feed', current: false },
  { name: 'Contact Me', href: '#creator',  current: false },
]
...
export default function Navbar() {
  return (
    <Disclosure
      as="nav"
      className="fixed top-0 inset-x-0 z-50 bg-gray-900/80 backdrop-blur-md after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10"
    >
